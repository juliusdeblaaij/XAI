from xDNN.xDNN_run_custom import train, validate, classify
...
case = "as a developer id like to create a gpload tasklet so i can ingest data from various sources into gpdb in an efficient manner"
...
case_embedding = doc2vec(stemmed_text, 'd2v_23k_dbow.model')
classification_result = classify(training_results, [case_embedding])
